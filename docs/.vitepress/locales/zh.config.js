        ...
        items: [
          {
            text: 'Vue',
            items: [
              { text: 'dc-vue', link: 'https://github.com/dailiwei/dc-vue' },
              {
                text: 'dc-vue-next',
                link: 'https://github.com/dailiwei/dc-vue-next',
              },
            ],
          },
          {
            ...
            items: [
              {
                text: 'vite-plugin-dc',
                link: 'https://github.com/dailiwei/vite-plugin-dc',
              },
              { text: 'dc-vite', link: 'https://github.com/dailiwei/dc-vite' },
            ],
          },
        ],
      },
